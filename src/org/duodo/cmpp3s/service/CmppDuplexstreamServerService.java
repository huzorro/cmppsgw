...
import org.duodo.cmpp3s.factory.pipeline.CmppDuplexstreamServerChannelPipelineFactory;
 ...
 *
 */
public class CmppDuplexstreamServerService implements Service {
     ...
     * @param duplexstreamServicesRunningList
     */
	public CmppDuplexstreamServerService(            
		...
		this(configMap, serverBootstrapMap, receiveMsgQueueMap,
				...
				sessionPoolMap, duplexstreamServicesRunningList, null);
	}    
	/**
	 * 
	 * @param configMap
	...
	protected void create(SessionConfig config) throws Exception {
		...
		DefaultServerSessionConfigFactory<SessionConfig> configFactory = new CmppUpstreamServerSessionConfigFactory<SessionConfig>(
				config);
		ChannelPipelineFactory pipelineFactory = new CmppDuplexstreamServerChannelPipelineFactory(
